...
function RegisterPage() {
    ...
    const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
        ...
        if (userId) {
            ...
            router.push('/auth/login')//Ye Client-side Navigation karta hai, jiska matlab hai ki page refresh nahi hota, sirf content change hota hai → Isse app fast aur smooth lagta hai.
        }
    };
            ...
            >
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div className="space-y-1">
                        <motion.label
                            htmlFor="name"
                            animate={isFocused ? { scale: 1, color: "grey", rotate: [0, 5, -5, 0] } : { scale: 1, color: "#000" }}
                        ...
                        <Input
                            ...
                            required
                            className=" from-[#414345] via-[#0f0f0f] to-[#414345] rounded-lg bg-gray-50 "
                            value={formData.name}
                    ...
                    <p className="text-center text-gray-700 text-sm">
                        ...
                        <Link href="/auth/login" className="text-red-700 hover:underline font-bold">
                            Sign In
                        </Link>
                    </p>
                </form>
